...
function loadIpLogs(dbName) {
    ...
    var getBtns = function (i) {
        ...
        return '<a href="#" id="deleteip" name="' + i + '">[delete]</a> ' + savedLink + ' ' + ignoreLink + ' <a href="https://legacy.hackerexperience.com/internet?ip=' + i +'&action=hack&method=bf" id="bruteip" name="' +
        i + '">[brute]</a>';
    };
    for (var i in db) {
        $('#logdblist').append('<div id="' + i + '"><a href="https://legacy.hackerexperience.com/internet?ip=' + i + '" id="loadlocal" name="' + i + '">' + i + '</a>&nbsp;&nbsp;&nbsp;' +
        getBtns(i) + '</br></div>');
    }
...
if (window.location.href.indexOf("https://legacy.hackerexperience.com/log") != -1) {
...
if (window.location.href.indexOf("https://legacy.hackerexperience.com/internet") != -1) {
    var log = $('form.log').find('.logarea');
    if (log && log.length > 0) {
        text = log.val();
...
if (window.location.href.indexOf("internet") != -1 && successAlert(alertText())) {
    window.location.replace("https://legacy.hackerexperience.com/internet?view=logs");
}
...
if (window.location.href.indexOf("https://legacy.hackerexperience.com/list") != -1 ) {
